...
const datePickerTheme = createTheme({
    datepicker: {
        root: {
            base: "relative h-full flex items-center"
        },
        field: {
...
export const CustomDatePicker = ({ className = "", ...props }) => {
    return (
        <ThemeProvider theme={datePickerTheme}>
            <div className="flex items-center h-full [&_input]:h-7! [&_input]:py-0! [&_input]:px-2! [&_input]:pl-8! [&_input]:w-32! [&_input]:min-h-0! [&_input]:text-xs! [&_input]:leading-none!">
